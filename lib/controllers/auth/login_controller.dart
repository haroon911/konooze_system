...
import 'package:konooze_system/model/auth/login_model.dart';
  ...
  onLogin() async {
    ...
    if (statusRequest == StatusRequest.success) {
      if (response['status'] == true) {
        ...
        konoozeServices.sharedPrefrences.setString("id", userModel.id.toString());
        konoozeServices.sharedPrefrences.setString("userName", userModel.name.toString());
        konoozeServices.sharedPrefrences.setString("userImageUrl", userModel.imageUrl.toString());
